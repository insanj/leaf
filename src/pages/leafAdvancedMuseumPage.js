...
export default function LeafAdvancedMuseumPage({ searchText, showOnlyActive=false, sortType, onSortTypeChange }) {
  ...
  return (
    <div className={classes.root}>
      <AppBar position="static">      
        <Tabs className={ classes.tabs } value={ selectedTab }  onChange={ handleTabChange } variant="scrollable" scrollButtons="auto" aria-label="tabs">
